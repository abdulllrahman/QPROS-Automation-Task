...
#    Then Validate WEB Element ["x-vf-trace-platform" "SMAPI_Presence"] for event ["Page" "page"]
...
#    Then Validate WEB Element ["x-vf-custom-authorization-id" "smapi-web-test"] for event ["UIControl" "BUTTON - submit"]
    ...
    Then Validate WEB Element ["x-vf-trace-network-bearer" "SMAPI_Presence"] for event ["UIControl" "BUTTON - submit"]
    Then Validate WEB Element ["x-vf-trace-os-name" "SMAPI_Presence"] for event ["UIControl" "BUTTON - submit"]
    Then Validate WEB Element ["x-vf-trace-os-version" "SMAPI_Presence"] for event ["UIControl" "BUTTON - submit"]
